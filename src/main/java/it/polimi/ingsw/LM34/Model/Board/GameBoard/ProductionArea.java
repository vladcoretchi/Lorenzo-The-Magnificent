...
public class ProductionArea implements GameSpace {
...
/*TODO: evalute where to place the penalty of -3 on the dice value in case of advancedSlot id est choice if it must be handled here or in the controller*/
    ...
    //slots loaded from configurator are passed to the constructor
    //the slots passed as parameter are to be already filled with the arbitrary reward they provide, which is specified
    //in the configuration file
    public ProductionArea(ArrayList<ActionSlot> slots, Integer diceValue, Integer advancedAreaDiceValue) throws ActionSlotInconsistencyException {
        if (slots.isEmpty()) {
